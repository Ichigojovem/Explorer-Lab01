...
const ccBgColor01 = window.document.querySelector(
  ".cc-bg svg > g g:nth-child(1) path"
)
const ccBgColor02 = window.document.querySelector(
...
const cardNumberPattern = {
  ...
  dispatch: function (appended, dynamicMasked) {
    ...
    return dynamicMasked.compiledMasks.find(function (item) {
